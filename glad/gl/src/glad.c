/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.34 on Sat Sep 30 04:26:08 2023.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=4.3, gles1=1.0, gles2=3.0, glsc2=2.0
